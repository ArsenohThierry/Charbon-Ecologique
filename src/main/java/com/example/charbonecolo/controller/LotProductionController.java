...
public LotProductionController(
        LotProductionService lotProductionService,
...
public String modifierLot(@PathVariable Integer id, Model model) {
    ...
    Optional<LotProductionModel> lot =
            lotProductionService.getLotProductionById(id);
